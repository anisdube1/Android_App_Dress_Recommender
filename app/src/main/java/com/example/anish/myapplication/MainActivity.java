...
//        new CityPreference(this).setCity("Bryan US");
    ...
    protected synchronized void buildGoogleApiClient() {
        ...
        Log.d("Location Updates","google api client connected.");
...
//        updateUIWidgets();
    ...
    protected void startIntentService() {
        ...
        Log.d("Location Updates","fetch3");
        startService(intent);
        Log.d("Location Updates","fetch-i m stuck");
    }
...
//        new CityPreference(this).setCity(mAddressOutput);
    ...
    private void updateUIWidgets() {
        if (mAddressRequested) {
            Log.d("Location Updates","fetch.3");
